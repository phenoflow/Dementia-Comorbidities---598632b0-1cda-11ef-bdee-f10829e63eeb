...
(async () => {
  ...
  await fs.writeFile("dementia-comorbidities-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("dementia-comorbidities-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
